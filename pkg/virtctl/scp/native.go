...
func (o *SCP) copyToRemote(client *scp.Client, localPath, remotePath string) error {
	...
	if o.recursive {
		...
		if err := client.CopyDirToRemote(localPath, remotePath, &scp.DirTransferOption{PreserveProp: o.preserve}); err != nil {
			return err
		}
	} else {
		if isDir {
		...
		if err := client.CopyFileToRemote(localPath, remotePath, &scp.FileTransferOption{PreserveProp: o.preserve}); err != nil {
			return err
		}
	}
...
func (o *SCP) copyFromRemote(client *scp.Client, localPath, remotePath string) error {
	...
	if o.recursive {
		...
		if err := client.CopyDirFromRemote(remotePath, localPath, &scp.DirTransferOption{PreserveProp: o.preserve}); err != nil {
			return err
		}
	} else {
		if exists && isDir {
		...
		if err := client.CopyFileFromRemote(remotePath, localPath, &scp.FileTransferOption{PreserveProp: o.preserve}); err != nil {
			return err
		}
	}
